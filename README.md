...
- Add screenshots of each module for your documentation
- Mention that the weekly wellness machine learning module is a decision tree classifier trained on a processed Kaggle-sourced sleep and lifestyle dataset
- Explain that `ml_service.py` is the clean boundary between the Flask routes and the ML model
- Explain that the PWA layer reuses the same Python backend through the shared API/core service
- If needed, you can seed demo data directly through the forms
