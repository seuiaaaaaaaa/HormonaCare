...
class User(db.Model):
    ...
    lifestyle_logs = db.relationship("LifestyleLog", backref="user", lazy=True, cascade="all, delete-orphan")
    ...
    push_subscriptions = db.relationship("WebPushSubscription", backref="user", lazy=True, cascade="all, delete-orphan")
    push_notification_logs = db.relationship("PushNotificationLog", backref="user", lazy=True, cascade="all, delete-orphan")
